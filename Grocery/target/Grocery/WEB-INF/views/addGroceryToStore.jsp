...
<body>
<form:form method="post" action="./addGrocery" commandName="grocery">

	<table>
	<tr>
		<td><form:label path="groceryName"><spring:message code="grocerystore.groceryName"/></form:label></td>
		<td><form:input path="groceryName" /></td> 
	</tr>
	<tr>
	...
	<tr>
		...
		<td><form:input path="groceryStock" /></td>
	</tr>
	<tr>
		<td><form:label path="groceryUpdatedOn"><spring:message code="grocerystore.groceryUpdatedOn"/></form:label></td>
		<td><form:input path="groceryUpdatedOn" /></td>
	</tr>	
	<tr>
		<td colspan="2">
			<input type="submit" value="<spring:message code="grocerystore.addGrocery"/>"/>
		</td>
	</tr>
</table>	
</form:form>
